...
"""Report biobanks that do not contain any collections."""
...
CHECK_DOCS = {'CEX:NoCollections': {'entity': 'BIOBANK',
                                                   'fields': ['id'],
                                                   'severity': 'ERROR',
	...
	def check(self, dir, args):
		...
		for biobank in dir.getBiobanks():
			...
			if len(collections.edges) < 1:
				warnings.append(DataCheckWarning(make_check_id(self, "NoCollections"), "", dir.getBiobankNN(biobank['id']), DataCheckWarningLevel.ERROR, biobank['id'], DataCheckEntityType.BIOBANK, str(biobank['withdrawn']), "Missing at least one collection for biobank"))
		return warnings
