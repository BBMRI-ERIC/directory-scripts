...
def test_contact_reuse_reports_cross_biobank_info_only():
    ...
    assert by_contact["ct_at_mug_specialist"].level.name == "INFO"
    assert "AT_MUG" in by_contact["ct_at_mug_specialist"].message
    assert "AT_MUW" in by_contact["ct_at_mug_specialist"].message
