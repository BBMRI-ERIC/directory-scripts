...
def test_load_fix_plan_reports_checksum_mismatch(tmp_path: Path):
    path = tmp_path / "updates.json"
    path.write_text(
        '{"format_version":1,"generated_at":"2026-03-04T00:00:00+00:00","generated_by":{"tool":"data-check.py","schema":"ERIC","withdrawn_scope":"active-only"},"updates":[{"update_id":"u1","module":"access","entity_type":"COLLECTION","entity_id":"col1","field":"data_use","mode":"append","confidence":"certain","current_value_at_export":[],"expected_current_value":[],"proposed_value":["DUO:0000020"],"human_explanation":"x","rationale":"","term_explanations":[],"source_check_ids":["AP:JointDuo"],"source_warning_messages":[],"source_warning_actions":[],"replace_required":false,"blocking_reason":"","exclusive_group":"","staging_area":"CZ","update_checksum":"broken"}],"file_checksum":"broken"}',
        encoding="utf-8",
    )
    loaded = load_fix_plan(path)
