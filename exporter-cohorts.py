...
"""Export cohort and population-based collections with aggregate counts."""
...
if not args.nostdout:
    ...
    print_fact_sheet_summary(cohortCollections, dir, allow_no_star_fact_sums=args.allow_no_star_fact_sums)
