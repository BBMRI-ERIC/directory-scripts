...
"""Export country-level Directory entity and fact-sheet statistics."""
...
if not args.nostdout:
    print_fact_sheet_summary(selectedCollections, dir, allow_no_star_fact_sums=args.allow_no_star_fact_sums)
...
if args.outputXLSX is not None:
    write_xlsx_tables(
        ...
        [
            ...
            *build_fact_sheet_xlsx_tables(selectedCollections, dir, allow_no_star_fact_sums=args.allow_no_star_fact_sums),
        ],
    )
